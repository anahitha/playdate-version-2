          ...
          <ImageBackground
            ...
            <View
              ...
              <Avatar
                ...
                size="medium"
                containerStyle={styles.imageContainer}></Avatar>
              <View
                style={{
                ...
                <Text
                  style={{ fontWeight: 'bold', fontSize: 16, paddingTop: 10, color: 'white'}}>
                  {this.state.name}
                </Text>
                <Text style={{ fontSize: 16, color: 'white' }}>{this.state.userId}</Text>
              </View>
            </View>
            <View
              style={{
